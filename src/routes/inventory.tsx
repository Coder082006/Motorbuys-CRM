      ...
      <div>
        {isLoading ? (
          ...
          <Card className="p-6 text-center">
            <p className="font-semibold">No motorbikes found</p>
            <p className="text-sm text-muted-foreground">
              Add your first motorbike to get started.
            </p>
              ...
              <Card key={b.id} className="overflow-hidden hover:shadow-lg transition-shadow group">
                ...
                <div className="p-4 space-y-2">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <Badge className={statusStyles[mapStatusLabel(b.status)]}>
    ...
    >
      <DialogTrigger asChild>
        <Button
          ...
          className="bg-brand-orange hover:bg-brand-orange/90 text-brand-navy"
        >
          <Plus className="h-4 w-4 mr-1" /> Add Motorbike
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={submit} className="grid gap-4 grid-cols-1 md:grid-cols-2">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              value={form.color}
              onValueChange={(v) => setForm((s: any) => ({ ...s, color: v }))}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              type="number"
              value={form.year}
              onChange={(e) => setForm((s: any) => ({ ...s, year: Number(e.target.value) }))}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setForm((s: any) => ({ ...s, chassis_number: e.target.value }))}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setForm((s: any) => ({ ...s, engine_number: e.target.value }))}
            />
          </div>
          <div className="space-y-1.5">
          ...
          {errors._general && (
            <div className="md:col-span-2 text-destructive">{errors._general}</div>
          )}
        </form>
        <DialogFooter>
          <Button
          ...
          >
            {creating || updating ? "Saving..." : form?.id ? "Save Changes" : "Save Bike"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
