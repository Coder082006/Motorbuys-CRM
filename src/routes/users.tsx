  ...
  if (usersQ.isError)
    return (
      <Card className="p-6">
        ...
        <div className="pt-2">
          <Button onClick={() => usersQ.refetch()}>Retry</Button>
        </div>
      </Card>
    );
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Admins see all pages. Other roles see only their allowed modules.
          </p>
        </div>
        <div className="flex gap-2">
          <Button onClick={() => setOpenProfileEdit(true)}>Edit Profile</Button>
                  ...
                  <TableCell className="text-right">
                    <div className="inline-flex gap-1">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (confirm("Delete user?")) deleteUserMut.mutate(u.id);
                        }}
                      >
      ...
      <DialogContent className="max-w-lg">
        ...
        <form onSubmit={submit} className="grid grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setForm((s: any) => ({ ...s, first_name: e.target.value }))}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setForm((s: any) => ({ ...s, last_name: e.target.value }))}
            />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              value={form.role}
              onValueChange={(v) => setForm((s: any) => ({ ...s, role: v }))}
            >
              <SelectTrigger>
          ...
          {!form.id && (
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => setForm((s: any) => ({ ...s, password2: e.target.value }))}
              />
            </div>
          )}
        </form>
        <DialogFooter>
          <Button
            ...
            disabled={creating}
          >
            {creating ? "Saving..." : form.id ? "Save Changes" : "Create User"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
        ...
        <form onSubmit={submit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setForm((s: any) => ({ ...s, old_password: e.target.value }))}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setForm((s: any) => ({ ...s, new_password: e.target.value }))}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setForm((s: any) => ({ ...s, confirm_password: e.target.value }))}
            />
          </div>
        </form>
        <DialogFooter>
